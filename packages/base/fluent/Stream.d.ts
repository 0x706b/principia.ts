...
import type * as S from '@principia/base/experimental/Stream'
...
declare module '@principia/base/IO/experimental/Stream/core' {
  export interface Stream<R, E, A> {
    /**
     * @rewrite aggregateAsync_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite aggregateAsyncWithin_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite bimap_ from "@principia/base/IO/experimental/Stream"
     */
    bimap<R, E, A, E1, A1>(this: Stream<R, E, A>, f: (e: E) => E1, g: (a: A) => A1): Stream<R, E1, A1>
    /**
     * @rewrite broadcast_ from "@principia/base/IO/experimental/Stream"
     */
    broadcast<R, E, A>(
      this: Stream<R, E, A>,
      n: number,
    ...
    /**
     * @rewrite broadcastDynamic_ from "@principia/base/IO/experimental/Stream"
     */
    broadcastDynamic<R, E, A>(this: Stream<R, E, A>, maximumLag: number): M.Managed<R, never, Stream<unknown, E, A>>
    /**
     * @rewrite broadcastQueues_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite broadcastQueuesDynamic_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite buffer_ from "@principia/base/IO/experimental/Stream"
     */
    buffer<R, E, A>(this: Stream<R, E, A>, capacity: number): Stream<R, E, A>
    /**
     * @rewrite bufferChunks_ from "@principia/base/IO/experimental/Stream"
     */
    bufferChunks<R, E, A>(this: Stream<R, E, A>, capacty: number): Stream<R, E, A>
    /**
     * @rewrite bufferChunksDropping_ from "@principia/base/IO/experimental/Stream"
     */
    bufferChunksDropping<R, E, A>(this: Stream<R, E, A>, capacity: number): Stream<R, E, A>
    /**
     * @rewrite bufferChunksSliding_ from "@principia/base/IO/experimental/Stream"
     */
    bufferChunksSliding<R, E, A>(this: Stream<R, E, A>, capacity: number): Stream<R, E, A>
    /**
     * @rewrite bufferDropping_ from "@principia/base/IO/experimental/Stream"
     */
    bufferDropping<R, E, A>(this: Stream<R, E, A>, capacity: number): Stream<R, E, A>
    /**
     * @rewrite bufferSliding_ from "@principia/base/IO/experimental/Stream"
     */
    bufferSliding<R, E, A>(this: Stream<R, E, A>, capacity: number): Stream<R, E, A>
    /**
     * @rewrite bufferUnbounded_ from "@principia/base/IO/experimental/Stream"
     */
    bufferUnbounded: Stream<R, E, A>
    /**
     * @rewrite catchAll_ from "@principia/base/IO/experimental/Stream"
     */
    catchAll<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, f: (e: E) => Stream<R1, E1, A1>): Stream<R & R1, E1, A1 | A>
    /**
     * @rewrite catchAllCause_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite chainPar_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite changesWith_ from "@principia/base/IO/experimental/Stream"
     */
    changesWith<R, E, A>(this: Stream<R, E, A>, f: (x: A, y: A) => boolean): Stream<R, E, A>
    /**
     * @rewrite chunkN_ from "@principia/base/IO/experimental/Stream"
     */
    chunkN<R, E, A>(this: Stream<R, E, A>, n: number): Stream<R, E, A>
    /**
     * @rewriteGetter chunks from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite collectRight from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite combine_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite cross_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite crossFirst_ from "@principia/base/IO/experimental/Stream"
     */
    crossFirst<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: Stream<R1, E1, A1>): Stream<R & R1, E1 | E, A>
    /**
     * @rewrite crossSecond_ from "@principia/base/IO/experimental/Stream"
     */
    crossSecond<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: Stream<R1, E1, A1>): Stream<R & R1, E1 | E, A1>
    /**
     * @rewrite crossWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite debounce_ from "@principia/base/IO/experimental/Stream"
     */
    debounce<R, E, A>(this: Stream<R, E, A>, duration: number): Stream<R & Has<Clock>, E, A>
    /**
     * @rewrite distributedWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite dropUntil_ from "@principia/base/IO/experimental/Stream"
     */
    dropUntil<R, E, A>(this: Stream<R, E, A>, predicate: P.Predicate<A>): Stream<R, E, A>
    /**
     * @rewrite dropWhile_ from "@principia/base/IO/experimental/Stream"
     */
    dropWhile<R, E, A>(this: Stream<R, E, A>, predicate: P.Predicate<A>): Stream<R, E, A>
    /**
     * @rewriteGetter either from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite findIO_ from "@principia/base/IO/experimental/Stream"
     */
    findIO<R, E, A, R1, E1>(this: Stream<R, E, A>, f: (a: A) => I.IO<R1, E1, boolean>): Stream<R & R1, E | E1, A>
    /**
     * @rewrite flattenChunks from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewriteGetter forever from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite groupBy_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite interleaveWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite interruptWhen_ from "@principia/base/IO/experimental/Stream"
     */
    interruptWhen<R, E, A, R1, E1>(this: Stream<R, E, A>, io: I.IO<R1, E1, any>): Stream<R & R1, E | E1, A>
    /**
     * @rewrite intersperse_ from "@principia/base/IO/experimental/Stream"
     */
    intersperse<R, E, A, A1>(this: Stream<R, E, A>, middle: A1): Stream<R, E, A | A1>
    /**
     * @rewrite loopOnChunks_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite loopOnPartialChunks_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite loopOnPartialChunksElements_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite map_ from "@principia/base/IO/experimental/Stream"
     */
    map<R, E, A, B>(this: Stream<R, E, A>, f: (a: A) => B): Stream<R, E, B>
    /**
     * @rewrite mapAccum_ from "@principia/base/IO/experimental/Stream"
     */
    mapAccum<R, E, A, S, B>(this: Stream<R, E, A>, s: S, f: (s: S, a: A) => readonly [B, S]): Stream<R, E, B>
    /**
     * @rewrite mapAccumIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapChunks_ from "@principia/base/IO/experimental/Stream"
     */
    mapChunks<R, E, A, A1>(this: Stream<R, E, A>, f: (chunk: C.Chunk<A>) => C.Chunk<A1>): Stream<R, E, A1>
    /**
     * @rewrite mapChunksIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapConcat_ from "@principia/base/IO/experimental/Stream"
     */
    mapConcat<R, E, A, B>(this: Stream<R, E, A>, f: (a: A) => Iterable<B>): Stream<R, E, B>
    /**
     * @rewrite mapConcatChunk_ from "@principia/base/IO/experimental/Stream"
     */
    mapConcatChunk<R, E, A, B>(this: Stream<R, E, A>, f: (a: A) => C.Chunk<B>): Stream<R, E, B>
    /**
     * @rewrite mapConcatChunkIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapConcatIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapError_ from "@principia/base/IO/experimental/Stream"
     */
    mapError<R, E, A, E1>(this: Stream<R, E, A>, f: (e: E) => E1): Stream<R, E1, A>
    /**
     * @rewrite mapErrorCause_ from "@principia/base/IO/experimental/Stream"
     */
    mapErrorCause<R, E, A, E1>(this: Stream<R, E, A>, f: (e: Cause<E>) => Cause<E1>): Stream<R, E1, A>
    /**
     * @rewrite mapIO_ from "@principia/base/IO/experimental/Stream"
     */
    mapIO<R, E, A, R1, E1, B>(this: Stream<R, E, A>, f: (a: A) => I.IO<R1, E1, B>): Stream<R & R1, E | E1, B>
    /**
     * @rewrite mapIOPar_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapIOParUnordered_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mapIOPartitioned_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite merge_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite mergeWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite onError_ from "@principia/base/IO/experimental/Stream"
     */
    onError<R, E, A, R1>(this: Stream<R, E, A>, cleanup: (e: Cause<E>) => I.IO<R1, never, any>): Stream<R & R1, E, A>
    /**
     * @rewrite orElse_ from "@principia/base/IO/experimental/Stream"
     */
    orElse<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: () => Stream<R1, E1, A1>): Stream<R & R1, E1, A | A1>
    /**
     * @rewrite orElseEither_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite orElseFail_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite partition_ from "@principia/base/IO/experimental/Stream"
     */
    partition(
    ...
    /**
     * @rewrite partitionIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite partitionMap_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite partitionMapIO_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite peel_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite repeat_ from "@principia/base/IO/experimental/Stream"
     */
    repeat<R, E, A, R1, B>(this: Stream<R, E, A>, schedule: Schedule<R1, any, B>): Stream<R & R1 & Has<Clock>, E, A>
    /**
     * @rewrite repeatEither_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite repeatElements_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite repeatElementsEither_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite repeatElementsWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite repeatWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite run_ from "@principia/base/IO/experimental/Stream"
     */
    run<R, E, A, R2, E2, Z>(this: Stream<R, E, A>, sink: Sink<R2, E, A, E2, unknown, Z>): I.IO<R & R2, E2, Z>
    /**
     * @rewriteGetter runCollect from "@principia/base/IO/experimental/Stream"
     */
    runCollect: I.IO<R, E, C.Chunk<A>>
    /**
     * @rewriteGetter runDrain from "@principia/base/IO/experimental/Stream"
     */
    runDrain: I.IO<R, E, void>
    /**
     * @rewrite runForeach_ from "@principia/base/IO/experimental/Stream"
     */
    runForeach<R, E, A, R1, E1>(this: Stream<R, E, A>, f: (a: A) => I.IO<R1, E1, any>): I.IO<R & R1, E | E1, void>
    /**
     * @rewrite runForeachChunk_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite runForeachManaged_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite runInto_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite runIntoElementsManaged_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite runIntoManaged_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite runManaged_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite schedule_ from "@principia/base/IO/experimental/Stream"
     */
    schedule<R, E, A, R1>(this: Stream<R, E, A>, schedule: Schedule<R1, A, any>): Stream<R & R1 & Has<Clock>, E, A>
    /**
     * @rewrite scheduleEither_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite scheduleWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite subsumeEither from "@principia/base/IO/experimental/Stream"
     */
    subsumeEither<R, E, E2, A>(this: Stream<R, E, E.Either<E2, A>>): Stream<R, E | E2, A>
    /**
     * @rewrite take_ from "@principia/base/IO/experimental/Stream"
     */
    take<R, E, A>(this: Stream<R, E, A>, n: number): Stream<R, E, A>
    /**
     * @rewriteGetter toAsyncIterable from "@principia/base/IO/experimental/Stream"
     */
    toAsyncIterable: M.Managed<R, never, AsyncIterable<E.Either<E, A>>>
    /**
     * @rewrite toHub_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite toQueueDropping_ from "@principia/base/IO/experimental/Stream"
     */
    toQueueDropping<R, E, A>(this: Stream<R, E, A>, capacity?: number): M.Managed<R, never, Dequeue<Take<E, A>>>
    /**
     * @rewrite toQueueOfElements_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewrite toQueueUnbounded_ from "@principia/base/IO/experimental/Stream"
     */
    toQueueUnbounded: M.Managed<R, never, UQueue<Take<E, A>>>
    /**
     * @rewrite zip_ from "@principia/base/IO/experimental/Stream"
     */
    zip<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: Stream<R1, E1, A1>): Stream<R1 & R, E | E1, readonly [A, A1]>
    /**
     * @rewrite zipFirst_ from "@principia/base/IO/experimental/Stream"
     */
    zipFirst<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: Stream<R1, E1, A1>): Stream<R1 & R, E | E1, A>
    /**
     * @rewrite zipSecond_ from "@principia/base/IO/experimental/Stream"
     */
    zipSecond<R, E, A, R1, E1, A1>(this: Stream<R, E, A>, that: Stream<R1, E1, A1>): Stream<R1 & R, E | E1, A1>
    /**
     * @rewrite zipWith_ from "@principia/base/IO/experimental/Stream"
     */
    ...
    /**
     * @rewriteGetter zipWithIndex from "@principia/base/IO/experimental/Stream"
     */
