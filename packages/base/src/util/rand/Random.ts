...
export class Random {
  ...
  private uniformIn(rangeMin: number, rangeMax: number): number {
    return prand.uniformIntDistribution(rangeMin, rangeMax, this.internalRng)
  }
  ...
  nextBigInt(min: bigint, max: bigint): bigint {
    return prand.uniformBigIntDistribution(min, max, this.internalRng)
  }
  ...
  nextArrayInt(
    ...
    return prand.uniformArrayIntDistribution(min, max, this.internalRng)
  }
